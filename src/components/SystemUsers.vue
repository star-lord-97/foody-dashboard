    ...
    <div class="flex flex-col">
        <div class="px-4 pt-10 pb-6 flex justify-between">
            <div class="flex items-center space-x-6">
                <h1 class="font-semibold text-xl">System Users</h1>
                <div
                    class="
            ...
            <div class="flex items-center space-x-4">
                <button
                    ...
                    "
                    @click="state.showNewUserModal = true"
                >
                    <span>New Admin/Staff/Delivery</span>
                </button>
            </div>
        </div>
        <div class="flex flex-col p-6 space-y-2">
            <div class="flex flex-row text-grayText text-sm divide-x-2">
                ...
                <span class="pl-2 w-2/12">Name</span>
                <span class="pl-2 w-2/12">Username</span>
                <span class="pl-2 w-3/12">Role</span>
                <span class="pl-2 w-3/12">Phone</span>
            ...
            >
                ...
                <span class="pl-2 w-2/12">{{ user.name }}</span>
                <span class="pl-2 w-2/12">{{ user.username }}</span>
                <span class="pl-2 w-3/12">{{
                    user.is_superuser
                        ? "Admin"
                        : user.is_staff
                        ? "Staff"
                ...
                <span class="pl-2 w-3/12">{{ user.mobile }}</span>
                <div class="pl-2 flex items-center space-x-4">
                    <svg
                        ...
                        class="h-5 w-5 cursor-pointer"
                        @click="
                            state.deleteUser.showDeleteModal = true;
                            state.deleteUser.userToDelete = user;
                        "
                    >
                        <rect width="256" height="256" fill="none"></rect>
                        <line
